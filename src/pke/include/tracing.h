...
struct FunctionTracer {
    ...
    virtual void registerInput(NativeInteger value, std::string name = "", bool isisMutable = false)      = 0;
    ...
    virtual void registerInput(const std::map<uint32_t, EvalKey<Element>>& evalKeyMap, std::string name = "",
                               bool isisMutable = false)                                                  = 0;
    virtual void registerInput(const std::shared_ptr<std::vector<Element>>& digits, std::string name = "",
                               bool isisMutable = false)                                                  = 0;
    virtual void registerInput(const std::shared_ptr<seriesPowers<Element>>& powers, std::string name = "",
                               bool isisMutable = false)                                                  = 0;
    ...
    virtual std::shared_ptr<std::vector<Element>> registerOutput(std::shared_ptr<std::vector<Element>> digits,
                                                                 std::string name = "")               = 0;
    virtual std::shared_ptr<seriesPowers<Element>> registerOutput(std::shared_ptr<seriesPowers<Element>> powers,
                                                                  std::string name = "")              = 0;
};
...
public:
    ...
    virtual void registerInput(NativeInteger, std::string, bool isMutable = false) override {}
    ...
    virtual void registerInput(const std::map<uint32_t, EvalKey<Element>>&, std::string,
                               bool isMutable = false) override {}
    virtual void registerInput(const std::shared_ptr<std::vector<Element>>&, std::string,
                               bool isMutable = false) override {}
    virtual void registerInput(const std::shared_ptr<seriesPowers<Element>>&, std::string,
                               bool isMutable = false) override {}
